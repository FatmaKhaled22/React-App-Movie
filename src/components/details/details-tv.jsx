      ...
      <div className="container details">
        <div className="row m-5 g-5" key={tv.id}>
          <div className="col-md-4 container-cover">
            <img className="card-img-top mb-md-0 rounded" src={url_img} alt="tv Cover"/>
          </div>
          <div className="col-md-8">
            ...
            {/* <p className="my-2"><i className="bi bi-flag-fill"></i> Country : {tv.production_countries.map((c)=>{
              return(
